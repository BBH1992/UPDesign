    ...
    public class PXR_HandPose : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (trackType == TrackType.Right || trackType == TrackType.Any)
            {
                ...
                {
                    if (rightHandJointLocations.jointLocations == null)
                    {
                        break;
                    }
                    if (i > rightHandJointLocations.jointLocations.Length - 1)
                    {
                        break;
                    }
            ...
            if (trackType == TrackType.Left || trackType == TrackType.Any)
            {
                ...
                {
                    if (leftHandJointLocations.jointLocations == null)
                    {
                        break;
                    }

                    if (i > leftHandJointLocations.jointLocations.Length - 1)
                    {
                        break;
                    }
        ...
        {
            if (finger.flexion == ShapesRecognizer.Flexion.Any)
            {
                return true;
            }
            else
        ...
        {
            if (finger.curl == ShapesRecognizer.Curl.Any)
            {
                return true;
            }
            else
        ...
        {
            if (finger.abduction == ShapesRecognizer.Abduction.Any)
            {
                return true;
            }
            else
