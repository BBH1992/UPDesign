...
{
    [InitializeOnLoad]
    public class DoozyUIManager_GitIgonreFixer
    {
        static DoozyUIManager_GitIgonreFixer()
        {
            // 将本插件加入到.gitignore中
            FixerGitIgonre();
        ...
        {
            //获取当前脚本的路径
            string scriptPath = DreamRiverEditorExtend.GetScriptAssetPath(nameof(DoozyUIManager_GitIgonreFixer));
