...
{
    [InitializeOnLoad]
    public class XR_XRInteractionToolkitFixer
    {
        static XR_XRInteractionToolkitFixer()
        {
            // 将本插件加入到.gitignore中
            FixerGitIgonre();
        ...
        {
            //获取当前脚本的路径
            string scriptPath = DreamRiverEditorExtend.GetScriptAssetPath(nameof(XR_XRInteractionToolkitFixer));
