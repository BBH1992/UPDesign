...
namespace SKODE
{
    public class Entity_RightHand : SingleMonoBehaviour<Entity_RightHand>
    {
        /// <summary>
        /// 控制器是否连接
        ...
        public Action OnAEnter;
        public Action OnADown;
        public Action OnAUp;

        public Action OnBEnter;
        ...
        private void Update()
        {
            ...
            {
                DreaRiverXR_Predefine.ButtonDispatchModel(_inputDevice, CommonUsages.triggerButton, OnTriggerEnter,
                    OnTriggerDown, OnTriggerUp);
                DreaRiverXR_Predefine.ButtonDispatchModel(_inputDevice, CommonUsages.gripButton, OnGripEnter,
                    OnGripDown, OnGripUp);
                DreaRiverXR_Predefine.ButtonDispatchModel(_inputDevice, CommonUsages.primaryButton,
                    OnAEnter, OnADown, OnAUp);
                DreaRiverXR_Predefine.ButtonDispatchModel(_inputDevice, CommonUsages.secondaryButton,
                    OnBEnter, OnBDown, OnBUp);
