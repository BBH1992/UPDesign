...
{
    [InitializeOnLoad]
    public class Dotween_GitIgonreFixer
    {
        static Dotween_GitIgonreFixer()
        {
            // 将本插件加入到.gitignore中
            FixerGitIgonre();
        ...
        {
            //获取当前脚本的路径
            string scriptPath = DreamRiverEditorExtend.GetScriptAssetPath(nameof(Dotween_GitIgonreFixer));
